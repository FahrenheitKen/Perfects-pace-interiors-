					...
					<div class="col-xl-6 col-lg-6">
						<div class="wow <?php echo esc_attr($main_class); ?>" data-wow-delay="100ms" data-wow-duration="2500ms">
							...
							<div class="banners__content">
								<?php
								if (!empty($item['title'])) :
									pitoon_basic_rendered_content($this, $item,  'title', 'banners__left-title', $item['title_tag_layout_one']);
								endif;

								if (!empty($item['sub_title'])) :
									pitoon_basic_rendered_content($this, $item,  'sub_title', $sub_title_class, 'p');
								endif;

								if (!empty($item['button_label'])) :
									pitoon_basic_rendered_content($this, $item,  'button_label', $btn_class, 'a', 'button_url');
								endif;
								?>
							</div>
						</div>
