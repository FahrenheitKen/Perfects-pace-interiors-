		...
		<div class="container">
			...
			<div class="owl-carousel thm-owl__carousel owl-with-shadow" data-owl-options='<?php echo esc_attr(pitoon_get_owl_options($settings)); ?>'>
				...
				?>
					...
					<div class="item wow fadeInUp" data-wow-delay="<?php echo esc_attr($i); ?>00ms">
						<div class="blog-two__single">
							<?php if (has_post_thumbnail()) : ?>
								<div class="blog-two__img-box">
									<div class="blog-two__img">
										<?php the_post_thumbnail('pitoon_blog_180X260'); ?>
							...
							<div class="blog-two__content">
								...
								<p class="blog-two__text"><?php echo esc_html(wp_trim_words(get_the_content(), $settings['content_length'], '')); ?></p>
								<div class="blog-two__comment-and-btn-box">
									...
									<div class="blog-two__btn-box">
										<a href="<?php the_permalink(); ?>" class="blog-two__btn"><?php echo esc_html($settings['read_more']); ?><span class="fa fa-play"></span></a>
									</div>
								</div>
							</div>
						</div>
