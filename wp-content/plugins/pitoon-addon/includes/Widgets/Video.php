...
class Video extends \Elementor\Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        include pitoon_get_elementor_option('video-one-option.php');
        //General style
        $this->start_controls_section(
            'general_style',
            [
        ...
        pitoon_elementor_general_style_options($this, 'Title', '{{WRAPPER}} .video-one__title', ['layout_one']);
    ...
    protected function render()
    {
        ...
        include pitoon_get_template('video-one.php');
    }
}
