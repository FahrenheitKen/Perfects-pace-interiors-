...
class Trust extends \Elementor\Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        include pitoon_get_elementor_option('trust-one-option.php');
        ...
        pitoon_elementor_general_style_options($this, 'Title', '{{WRAPPER}} .trust-one__title', ['layout_one']);
    ...
    protected function render()
    {
        ...
        include pitoon_get_template('trust-one.php');
    }
}
