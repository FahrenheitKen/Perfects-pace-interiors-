...
class Login extends \Elementor\Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        include  pitoon_get_elementor_option('login-one-option.php');
        ...
        pitoon_elementor_general_style_options($this, 'Remember Me', '{{WRAPPER}} .login-page__form-input-box label', ['layout_one']);
        pitoon_elementor_general_style_options($this, 'Forgot Password', '{{WRAPPER}} .login-page__form-forgot-password a', ['layout_one']);
    ...
    protected function render()
    {
        ...
        include pitoon_get_template('login-one.php');
    }
}
